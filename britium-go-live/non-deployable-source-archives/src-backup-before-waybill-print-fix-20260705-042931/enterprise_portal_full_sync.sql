...
drop function if exists public.be_enterprise_portal_healthcheck();
drop function if exists public.be_supervisor_portal_snapshot();
drop function if exists public.be_supervisor_pickup_snapshot();
drop function if exists public.be_supervisor_wayplan_snapshot();
drop function if exists public.be_finance_portal_snapshot();
drop function if exists public.be_invoice_studio_snapshot();
drop function if exists public.be_cod_settlement_snapshot();
drop function if exists public.be_rider_settlement_snapshot(text, date);
drop function if exists public.be_customer_portal_snapshot(text, text, text);
drop function if exists public.be_branch_office_portal_snapshot(text, text);
drop function if exists public.be_portal_sync_smoke_test();
