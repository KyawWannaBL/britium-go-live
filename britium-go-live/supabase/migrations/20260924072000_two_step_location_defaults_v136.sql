...
-- Exact provider result first; then 7-digit postal/ward default; then township default.
-- Accepted generic defaults are routing coordinates and do not require location review.
