-- V124: expose all warehouse-ready regional rows in Wayplan Command.
-- Rows without accepted coordinates remain visible but are not route-selectable.
...
begin
  ...
  return jsonb_build_object(
    ...
    'build','WAYPLAN_VISIBLE_QUEUE_V124_20260923'
  );
end
$function$;
