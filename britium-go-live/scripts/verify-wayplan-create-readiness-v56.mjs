...
const checks = [
  ["crew edits preserve below-minimum approval", planner.includes("reset(repairCrewGaps(next), true)")],
  ...
  ["missing rider is explained", planner.includes("choose a Rider")],
  ["auto crew repair exists", planner.includes("Auto-assign missing Driver / Rider")],
  ["driver and rider labels are mandatory", planner.includes("Driver *") && planner.includes("Rider *")],
