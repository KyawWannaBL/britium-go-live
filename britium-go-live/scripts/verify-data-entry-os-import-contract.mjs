...
const checks=[
  ...
  ["bulk locations enter the downloadable review queue immediately",/locationStatus:\(destination\.mapRequired\?"REVIEW_REQUIRED":"NOT_REQUIRED"\)/.test(page)&&/Queued for consolidated Excel location review/.test(page)],
