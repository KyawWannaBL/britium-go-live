...
const checks=[
  ...
  ["background location validation is concurrency limited",/Math\.min\(3,jobs\.length\)/.test(page)&&/await validateImportedLocation\(job\)/.test(page)&&/genuinely need review/.test(page)],
