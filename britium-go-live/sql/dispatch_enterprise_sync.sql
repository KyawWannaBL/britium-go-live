...
-- -------------------------------------------------------------------------
drop view if exists public.be_v_enterprise_dispatch_jobs;
drop view if exists public.be_v_enterprise_dispatch_wayplans;
drop view if exists public.be_v_rider_dispatch_jobs;
