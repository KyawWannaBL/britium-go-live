...
function sharedLabelCss() {
  return `
    * { box-sizing: border-box; }
    ...
    .full-head { position: relative; min-height: 0; display: grid; grid-template-columns: minmax(0, 1fr) 25mm; align-items: center; gap: 2mm; border-bottom: .3mm solid #111; padding: 5mm 1mm 2.5mm; overflow: hidden; }
    .full-brand { min-width: 0; display: grid; grid-template-columns: 12mm minmax(0, 1fr); align-items: center; gap: 3mm; padding: 0; }
    .full-brand .be-logo { width: 12mm; height: 12mm; font-size: 16pt; }
    .full-brand strong, .full-brand span, .full-brand b { display: block; }
    .full-brand strong { font-size: 12.5pt; line-height: 1.05; white-space: nowrap; font-weight: 700; letter-spacing: 0; }
    .full-brand span { margin-top: .8mm; font-size: 9pt; line-height: 1.1; white-space: nowrap; font-weight: 500; }
    .full-brand b { margin-top: .8mm; font-size: 7.3pt; line-height: 1.1; white-space: nowrap; font-weight: 500; }
    .full-code { width: 25mm; text-align: center; align-self: end; }
    ...
    .full-code .qr { width: 20mm; height: 20mm; margin: 0 auto .7mm; }
