...
export const GO_LIVE_TEMPLATE_SCHEMAS: TemplateSchema[] = [
  {
    ...
    csvFile: "/templates/Britium_Data_Entry_Production_Template.csv",
    xlsxFile: "/templates/Britium_Data_Entry_Production_Template.xlsx",
  ...
  },
  {
    ...
    csvFile: "/templates/Britium_Merchant_Customer_Production_Template.csv",
    xlsxFile: "/templates/Britium_Merchant_Customer_Production_Template.xlsx",
  ...
  },
  {
    ...
    csvFile: "/templates/Britium_Warehouse_Scan_Production_Template.csv",
    xlsxFile: "/templates/Britium_Warehouse_Scan_Production_Template.xlsx",
...
export function validateTemplateRows(schema: TemplateSchema, parsedHeaders: string[], rows: Record<string, string>[]) {
  ...
  rows.forEach((row) => {
    ...
    if (isDemoLikeRow(row)) errors.push("Mock/sample/demo/test row is not allowed in a production upload");
