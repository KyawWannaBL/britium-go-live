...
const BUILD = 'PORTAL_DATA_ENTRY_CLEAN_REVIEW_V61_4_DIST_VERIFY_2026_08_03';
...
if (missing.length || forbidden.length) fail('V61.4 compiled-dist verification failed.', { missing, forbidden_found: forbidden, scanned_files: files.length });
