-- Controlled rollback for Financial V2 township alias V61.4
-- Restores the exact pre-V61.4 core calculation function from the migration backup.
rollback;
begin;
do $rollback$
declare
...
begin
  ...
  if v_definition is null then
    raise exception 'ABORT: pre-V61.4 function backup was not found.';
  end if;
...
select jsonb_pretty(jsonb_build_object(
  'ok',true,
  'build','FINANCIAL_V2_TOWNSHIP_ALIAS_V61_4_ROLLBACK_2026_08_03',
