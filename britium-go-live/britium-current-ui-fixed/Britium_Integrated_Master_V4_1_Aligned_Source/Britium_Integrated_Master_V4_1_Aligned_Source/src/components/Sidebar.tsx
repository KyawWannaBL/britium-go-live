...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Network Fulfillment", path: "/network-fulfillment", icon: Route, badge: "V55" },
    ],
  },
  {
    title: "Management",
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Merchant Settlement", path: "/finance-merchant-settlement", icon: Wallet, badge: "V2" },
      ...
      { name: "NPT Branch Settlement", path: "/branch-settlement", icon: Building2, badge: "V1" },
      { name: "Partner Settlement", path: "/partner-settlement", icon: Handshake, badge: "V55" },
    ],
  },
  {
