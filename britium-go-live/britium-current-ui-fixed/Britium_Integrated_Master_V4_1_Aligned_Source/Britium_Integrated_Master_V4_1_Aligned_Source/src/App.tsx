...
const BranchOfficeSettlementPage = safeLazy(() => import('@/pages/branch/BranchOfficeSettlementPage'));
const NetworkFulfillmentPage = safeLazy(() => import('@/pages/NetworkFulfillmentPage'));
...
const LegacyDataEntryPage = safeLazy(() => import('@/pages/DataEntryPage'));
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route element={<AuthLayout />}>
            ...
            <Route path="/branch-settlement" element={<BranchOfficeSettlementPage />} />
            <Route path="/network-fulfillment" element={<NetworkFulfillmentPage />} />
            <Route path="/partner-settlement" element={<NetworkFulfillmentPage />} />
            ...
            <Route path="/data-entry-legacy" element={<LegacyDataEntryPage />} />
