...
export const GO_LIVE_TEMPLATE_SCHEMAS: TemplateSchema[] = [
  ...
  },
  {
    ...
    csvFile: "/templates/Britium_Merchant_Customer_Upload_Production_Template.csv",
    xlsxFile: "/templates/Britium_Merchant_Customer_Upload_Production_Template.xlsx",
