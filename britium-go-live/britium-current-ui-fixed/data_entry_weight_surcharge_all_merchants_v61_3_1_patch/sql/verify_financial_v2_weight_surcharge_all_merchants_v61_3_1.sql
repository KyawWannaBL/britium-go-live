-- Read-only verifier for Financial V2 V61.3.1.
...
tier_results as (
  ...
  select public.be_data_entry_financial_v2_calculate(jsonb_build_object(
    'merchant_id','UNREGISTERED_V61_3_1_VERIFY','customer_tier','STANDARD','township','Insein',
  ...
  select
    ...
    (select count(*) from tier_results where result->>'calculation_version'='PARCEL_FINANCIAL_V2_WEIGHT_PASS_THROUGH_V61_3_1')=3 as version_ok,
    ...
    exists(select 1 from public.be_audit_events where upload_code='FINANCIAL-V2-ALL-MERCHANTS-V61-3-1-20260802') as audit_recorded,
...
select jsonb_pretty(jsonb_build_object(
  'ok',functions_exist and all_three_tiers_ok and version_ok and schema_50 and tier_selector_exposed and unregistered_ok and unregistered_status_ok and unregistered_tier_ok and blocked_profile_guard_present and audit_recorded and mutation_shadow_preserved,
  'build','FINANCIAL_V2_ALL_MERCHANTS_V61_3_1_VERIFY_2026_08_02',
