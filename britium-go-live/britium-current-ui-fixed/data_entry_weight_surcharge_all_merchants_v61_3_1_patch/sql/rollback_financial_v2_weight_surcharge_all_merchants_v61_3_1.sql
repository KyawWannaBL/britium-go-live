-- Controlled rollback for V61.3.1. Use only after a confirmed regression and only in MUTATION_SHADOW.
begin;
...
$function$;
commit;
select jsonb_pretty(jsonb_build_object('ok',true,'build','ROLLBACK_FINANCIAL_V2_V61_3_1_TO_V61_3_V58_WRAPPER','mutation_mode',(select mutation_mode from public.be_data_entry_financial_v2_runtime_v58 where singleton),'financial_writes_enabled',false));
