...
import { CheckCircle2, Loader2, LocateFixed, Navigation, RefreshCw, Route, ShieldCheck } from "lucide-react";
...
export const RIDER_V46_ROUTE_BUILD = "RIDER_V46_HEAD_OFFICE_ROUTE_EXECUTION_2026-07-30";
...
export default function RiderRouteExecutionV46({ wayplan, rider, busy, onRefresh }: any) {
  ...
  return <div style={{ border: `1px solid ${status === "COMPLETED" ? C.green : C.blue}`, background: C.panel, borderRadius: 16, padding: 12, marginTop: 12 }}>
    ...
    <RiderMapboxRouteV45 wayplanId={wayplanId} />
  </div>;
}
