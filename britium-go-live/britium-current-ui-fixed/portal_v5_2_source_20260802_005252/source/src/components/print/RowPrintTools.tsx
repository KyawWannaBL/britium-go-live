      ...
      <body>
        ...
        <script>
          window.onload = function() {
            setTimeout(function(){ window.focus(); await guardedBrowserPrint({
      documentType: "INVOICE",
      documentNo: invoiceNo || selectedInvoice?.invoice_no || selectedInvoice?.invoiceNo || selectedInvoice?.delivery_way_id || selectedInvoice?.waybill_no || "INV-UNKNOWN",
      actorEmail: user?.email || "finance@britiumexpress.com",
      actorRole: userRole || "finance",
      reason: "Invoice Print Studio print",
    }); }, 250);
          };
        <\/script>
      </body>
