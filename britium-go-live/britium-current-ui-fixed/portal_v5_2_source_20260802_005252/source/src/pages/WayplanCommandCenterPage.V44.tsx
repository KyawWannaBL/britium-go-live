...
const BUILD_MARKER = "WAYPLAN_V44_EXCLUSIVE_ASSIGNMENT_MODES_FULL_FLEET_VISIBILITY_2026-07-30";
...
export default function WayplanCommandCenterPage() {
  ...
  async function createWayplan() {
    ...
    try {
      ...
      setNotice(`${createdId || "Wayplan"} created in ${assignmentMode === "RIDER" ? "Rider Delivery" : "Vehicle Crew"} mode with ${selectedRows.length} parcel(s). Next: submit it for Supervisor review.`);
      await loadAll(true);
    } catch (caught: any) {
