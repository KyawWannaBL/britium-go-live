...
Open and run the CONTENTS of:
  sql/20260802_financial_v2_weight_surcharge_all_merchants_v61_3_2.sql
Then run the CONTENTS of:
  sql/verify_financial_v2_weight_surcharge_all_merchants_v61_3_2.sql
Do not paste either file path into SQL Editor.

FRONTEND
  node ./data_entry_weight_surcharge_all_merchants_v61_3_2_patch/apply_data_entry_weight_surcharge_all_merchants_v61_3_2.mjs .
  node ./data_entry_weight_surcharge_all_merchants_v61_3_2_patch/verify_data_entry_weight_surcharge_all_merchants_v61_3_2.mjs .
  rm -rf dist node_modules/.vite
  npm run build
  node ./data_entry_weight_surcharge_all_merchants_v61_3_2_patch/verify_dist_data_entry_weight_surcharge_all_merchants_v61_3_2.mjs .
