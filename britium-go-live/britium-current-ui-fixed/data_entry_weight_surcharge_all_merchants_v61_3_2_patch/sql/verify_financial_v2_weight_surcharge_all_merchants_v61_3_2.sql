-- Read-only verifier for Financial V2 V61.3.2.
...
tier_results as (
  ...
  select public.be_data_entry_financial_v2_calculate(jsonb_build_object(
    'merchant_id','UNREGISTERED_V61_3_2_VERIFY','customer_tier','STANDARD','township','Insein',
  ...
  select
    ...
    (select count(*) from tier_results where result->>'calculation_version'='PARCEL_FINANCIAL_V2_WEIGHT_PASS_THROUGH_V61_3_2')=3 as version_ok,
    ...
    exists(select 1 from public.be_audit_events where upload_code='FINANCIAL-V2-ALL-MERCHANTS-V61-3-2-20260802') as audit_recorded,
...
select jsonb_pretty(jsonb_build_object(
  ...
  'build','FINANCIAL_V2_ALL_MERCHANTS_V61_3_2_VERIFY_2026_08_02',
  ...
  'next_gate','INSTALL_BUILD_AND_DEPLOY_V61_3_2_FRONTEND'
)) from checks;
