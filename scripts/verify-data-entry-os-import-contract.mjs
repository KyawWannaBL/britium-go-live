...
const checks=[
  ...
  ["background location validation is concurrency limited",/Math\.min\(8,jobs\.length\)/.test(page)&&/await validateImportedLocation\(job\)/.test(page)&&/genuinely need review/.test(page)],
  ["background validation times out instead of hanging",/Location validation timed out after 10 seconds/.test(page)&&/Promise\.race/.test(page)],
