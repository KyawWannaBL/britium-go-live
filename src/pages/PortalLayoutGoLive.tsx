...
// Import our newly created Print Studio pages
...
export default function PortalLayoutGoLive({ currentUser, onLogout }: { currentUser: any, onLogout: () => void }) {
  ...
  const navConfig = {
    "Super Admin": [
      ...
      { id: 'waybills', label: 'Waybill Studio', icon: Printer, component: <WaybillPrintStudioPage /> },
      { id: 'invoices', label: 'Invoice Studio', icon: FileText, component: <InvoicePrintStudioPage /> }
    ],
    Supervisor: [
      { id: 'assignment', label: 'Dispatch Assignment', icon: UserCircle, component: <SupervisorPickupAssignmentGoLivePage /> },
