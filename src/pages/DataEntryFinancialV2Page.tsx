...
const ParcelEditor = memo(function ParcelEditor({ row, index, updateRow, calculate, save, reviewPhoto, tariffOptions, providerOptions, tierAccess, locationReloadToken }: any) {
  ...
  && previous.tariffOptions === next.tariffOptions
  && previous.providerOptions === next.providerOptions
  && previous.tierAccess === next.tierAccess
  && previous.locationReloadToken === next.locationReloadToken);
